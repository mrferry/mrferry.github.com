...
<html>
  ...
  <body>
  <form action="FormAudit/saveAudit.action?status=form&id=<%=dc.getDemandId() %>" method="post">
    <table width="80%" border="1" align="center">
    	...
    	<td>技术审核</td>
    	<td colspan="5">
    		<label><input type="radio" name="form" value="审核通过" onClick="Close('otherModel')">审核通过</label>
        	<label><input type="radio" name="form" value="审核不通过" onClick="Close('otherModel')">审核不通过</label>
    	</td>
  	  </tr>
  	  <tr>
  	  	<td>部门审核单位</td>
  	  	<td colspan="5"><input type="text" name="department"></td>
  	  </tr>
  	  <tr>
    	<td>审核不通过原因</td>
